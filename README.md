...
## 1. Таблица совместимости флагов
...
## 2. Основные операции (обязательные и взаимоисключающие)
...
| `-a`, `--append`   | Добавление в архив       | `-c`, `-x`, `-u`, `-T`                   | `-c`, `-x`, `-u`, `-T`                |
| `-u`, `--update`   | Обновление архива        | `-c`, `-x`, `-a`, `-T`                   | `-c`, `-x`, `-a`, `-T`                |
| `-T`, `--test`     | Тестирование архива      | `-c`, `-x`, `-a`, `-u `                  | `-c`, `-x`, `-a`, `-u`                |

---
## 3. Флаги, зависящие от операции
...
## 4. Примеры конфликтных комбинаций ##
